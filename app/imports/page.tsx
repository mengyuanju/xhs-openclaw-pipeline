...
export default async function ImportsPage({
  ...
  return <>
    ...
    <Disclosure className="panel recent-imports-disclosure" defaultOpen={!initialBatch}>
      <DisclosureTrigger><span><strong>最近导入</strong><small>{initialBatch ? '当前批次处理完成后再展开查看' : `共 ${batches.length} 个最近批次`}</small></span><span className="subtle">展开记录</span></DisclosureTrigger><DisclosureContent>
