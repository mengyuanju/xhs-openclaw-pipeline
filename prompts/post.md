...
2. 标题不超过25个可见字符，不用问号、感叹号、波浪号、标题党或无法兑现的承诺。标题必须包含 Query 主需核心词，并补充正文真正给出的回答核心或看点；不得只删除空格后照抄 Query。
3. 正文严格为400–600字；第一段直接给出核心结论，可以使用客观说明、祈使式建议或安全的第一人称信息整理视角，但不强制叙述人称，也不得虚构购买、使用或亲测经历。全文按总—分—总组织，末段换一种说法再次收束核心结论。按内容类型选择正文结构：教程或操作流程可按必要顺序展开；推荐、盘点、对比测评按场景、标准、差异和取舍展开；科普、知识、答疑按结论、原因、误区和边界展开。不得默认写成“第一步、第二步、第三步”；只有顺序确实不能打乱时才使用编号步骤。Query 若承诺明确天数的行程，正文必须从第1天到最后一天逐日覆盖，每天写明起终点或当天安排，不得用“去程几天、停留几天、返程几天”等范围摘要替代。
4. 标题和正文都不得使用 emoji；iconDictionary 必须为空对象。
5. 真人感来自输入能够支持的具体物件、动作、位置、状态、犹豫点、失败表现和选择规则，也来自长短句变化与自然转折。可直接使用客观说明或对读者的操作建议；若使用第一人称，只能表达信息整理和结论，不得在没有用户证据时使用“我亲测”“我用了几个月”“本人购买”“我家一直”等证言。结尾可落在判断标准、例外情况或一个下一步动作，不强制检查清单。
