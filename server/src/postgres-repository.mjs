        ...
        candidate = await client.query(`
          WITH earliest_edits AS MATERIALIZED (
            ...
            WHERE $5::integer >= CASE
                WHEN edit.operation = 'TEXT' OR edit.operation LIKE 'AI_%' THEN 6
                ELSE 3
              END
