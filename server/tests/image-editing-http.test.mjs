...
test('all image-edit mutations and read endpoints reject non-admins before accessing storage',async()=>{
  ...
  try{
    for(const role of ['USER','REVIEWER'])for(const [method,path]of [
