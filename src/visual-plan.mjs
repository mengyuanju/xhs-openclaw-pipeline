...
export function buildVisualPlanPrompt(post, {
  ...
  const layoutRules = layoutCatalog ? internalPrompt('INTERNAL_VISUAL_LAYOUT_SELECTION') : layoutTemplatePromptRules();
  return businessPrompt('VISUAL_PLAN_SYSTEM', {
    contract: internalPrompt('INTERNAL_VISUAL_PLAN_OUTPUT', { slot1: (layoutRules), slot2: (imageCount), slot3: (complianceDisclosure || '关闭') }),
